...
(function ($) {
  ...
  //     if($( "input:checked" ).val() == "marketing"){
  //       $( "#log" ).html( "<select class='custom-select'>"+
  //         "<option selected>Seleccione el servicio marketing requerido</option>"+
  ...
  //     }else{
  //       if($( "input:checked" ).val() == "informatica"){
  //       $( "#log" ).html( "<select class='custom-select'><option selected>Seleccione el servicio informatico requerido</option><option value='1'>informatico</option></select> ");
  //     }
  //     }
